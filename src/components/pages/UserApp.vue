    ...
    <div class="mt-8 flex flex-col">
      <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
          <div class="flex flex-wrap overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg bg-white p-4">
            <div 
              v-if="!editUser"
            ...
            >
              <div class="flex flex-row items-start gap-2">
                <div class="w-[50px] h-[50px]">
                  <svg
                    class="size-12 h-full text-gray-300"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    aria-hidden="true"
                    data-slot="icon"
                ...
                <div class="flex flex-col">
                  <h2 
                    class="text-[18px] font-bold truncate transition-all"
                  >
              ...
              <div class="flex justify-center w-full mt-3">
                <button
                  ...
                  class="inline-flex w-full items-center justify-center rounded-md border border-transparent 
                                    ...
                                    focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 w-[100px]"
                >
                  Excluir
                </button>
              </div>
